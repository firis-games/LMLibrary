...
public class ModelMulti_Steve extends ModelMultiBase {
	...
	public void setDefaultPause(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		bipedHead.setRotationPoint(0.0F, 0.0F, 0.0F).setRotateAngleDeg(headPitch, netHeadYaw, 0.0F);
	...
	// // 頭部装飾品
	// boolean lplanter = ModelCapsHelper.getCapsValueBoolean(pEntityCaps,
	// caps_isPlanter);
	// if (ModelCapsHelper.getCapsValueBoolean(pEntityCaps, caps_isCamouflage) ||
	// lplanter) {
	// if (lplanter) {
