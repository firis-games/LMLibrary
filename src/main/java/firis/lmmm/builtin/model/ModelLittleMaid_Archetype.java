...
//		bipedHeadwear.rotateAngleY = bipedHead.rotateAngleY;
		...
		bipedRightArm.rotateAngleX = mh_cos(limbSwing * 0.6662F + 3.141593F) * 2.0F * limbSwingAmount * 0.5F;
		bipedLeftArm.rotateAngleX = mh_cos(limbSwing * 0.6662F) * 2.0F * limbSwingAmount * 0.5F;
		bipedRightArm.rotateAngleZ = 0.0F;
		bipedLeftArm.rotateAngleZ = 0.0F;
		bipedRightLeg.rotateAngleX = mh_cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
		bipedLeftLeg.rotateAngleX = mh_cos(limbSwing * 0.6662F + 3.141593F) * 1.4F * limbSwingAmount;
		...
		if (isWait) {
			// 待機状態の特別表示
			bipedRightArm.rotateAngleX = mh_sin(ageInTicks * 0.067F) * 0.05F - 0.7F;
			bipedRightArm.rotateAngleY = 0.0F;
			bipedRightArm.rotateAngleZ = -0.4F;
			bipedLeftArm.rotateAngleX = mh_sin(ageInTicks * 0.067F) * 0.05F - 0.7F;
			bipedLeftArm.rotateAngleY = 0.0F;
			...
			if (aimedBow) {
				...
				bipedRightArm.rotateAngleX += mh_sin(ageInTicks * 0.067F) * 0.05F;
